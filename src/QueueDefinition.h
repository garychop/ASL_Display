...
typedef enum FEATURE_ID {POWER_ONOFF_ID, BLUETOOTH_ID, NEXT_FUNCTION_ID, NEXT_PROFILE_ID, RNET_DRIVE_ID, RNET_SEATING_ID, NUM_FEATURES} FEATURE_ID_ENUM; // "invalid" must be last enum
