...
static uint8_t HeadArray_CommunicationThread_stack[1024] BSP_PLACE_IN_SECTION_V2(".stack.HeadArray_CommunicationThread") BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT);
