...
//****************************************************************************
// Description: This creates a queue msg to request the connected device
//      identification, either FUSION (no response) or ION.
//
//****************************************************************************
...
void SendWhoAmICommand (void)
{
    ...
    msg.m_MsgType = HHP_HA_WHO_ARE_YOU;
...
void SendWhoAmItoGUI (uint8_t deviceID)
{
    HHP_HA_MSG_STRUCT HHP_Msg;

    HHP_Msg.m_MsgType = HHP_HA_WHO_ARE_YOU;
    HHP_Msg.SendWhoAmiIStruct.m_DeviceID = deviceID;
